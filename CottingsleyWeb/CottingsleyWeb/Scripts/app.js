(function (modules) {
    ...
    var hotCurrentHash = "7d471647a97ad35970f8";
    ...
    (function ($) {
        ...
        $(document).ready(function () {
            ...
            screens.map(function (index, screens) {
                $('#btn-' + index + '-change').on('click', function () {
                    ...
                    if (screenIndexChange.hasClass('open-menu')) {
                        ...
                        pageChangeBullets.hide();
                        teamParallax1.attr('style', 'z-index: -1;');
                        $('#screen-' + index + '-change').addClass('open-menu').find(".btn-screen-bullet").on('click', function () {
                            screenBlackout.hide();
                            teamParallax1.attr('style', 'z-index: 1;');
            ...
            screens.on('appear', 'svg', function (e, $affected) {
                if (!$(this).hasClass('painted')) {
                    ...
                    if (mobile) {
                        $('.steps').find('svg').drawsvg('animate', {
                            duration: 2500
                        }).addClass('painted');
                    }
                }
            ...
            $('.mark').on('click', function () {
                if ($(this).hasClass('active')) {
                    ...
                    setTimeout(function () {
                        element.removeClass('active').find('.plus').show().find('.content').hide();
                    }, 5000);
                }
            });
            var heightsFromTop = [];
            ...
            youButtonMenu.find('svg').drawsvg('animate', {
                duration: 1
            }).addClass('painted');
            $('.change-page').find('svg').drawsvg('animate', {
                duration: 1
            }).addClass('painted');
            $('.change-screen').find('svg').drawsvg('animate', {
                duration: 1
            }).addClass('painted');
            $('#scroll-down').attr('style', 'animation: scroll-cta 2s infinite !important;').find('svg').drawsvg('animate', {
                duration: 1
            }).addClass('painted');
        ...
        $('#colors-bullet').find('a').map(function (i, color) {
            ...
            $(this).on('click', function () {
                ...
                var body = $('body');
                if (body.hasClass('theme-black') || body.hasClass('theme-blue-grey') || body.hasClass('theme-grey') || body.hasClass('theme-brown') || body.hasClass('theme-deep-orange') || body.hasClass('theme-orange') || body.hasClass('theme-amber') || body.hasClass('theme-yellow') || body.hasClass('theme-lime') || body.hasClass('theme-light-green') || body.hasClass('theme-green') || body.hasClass('theme-teal') || body.hasClass('theme-cyan') || body.hasClass('theme-light-blue') || body.hasClass('theme-blue') || body.hasClass('theme-indigo') || body.hasClass('theme-deep-purple') || body.hasClass('theme-purple') || body.hasClass('theme-pink') || body.hasClass('theme-red')) {
